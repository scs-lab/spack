...
class PyTyping(PythonPackage):
    ...
    depends_on('tensorflow@2.2.0', type=('build', 'run'))
    depends_on('tensorboard@2.2.2', type=('build', 'run'))
    depends_on('tensorboard-plugin-profile@2.10.0', type=('build', 'run'))
    depends_on('tensorboard-plugin-wit@1.7.0', type=('build', 'run'))
    depends_on('tensorflow-estimato@2.2.0',type=('build', 'run'))
